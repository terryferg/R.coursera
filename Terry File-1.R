...
vapply(flags, class, character(1)) # to make sure it is a character of 1 like expected
##  vapply() may perform faster than sapply() for
##  large datasets.
...
rm(test.merge)
### how to divide a column into two data variables
## library(tidyr)
separate(df, var2separate, c("new.variable1","newvar2"), sep =",")
...
##################      LOOPS #################################################
##  lapply -always returns a list of objects. it takes a list of objects and apply a 
##  function to every elemment of that list.
# 
## sapply - avariant of lapply that simplifies the result oflapply returns
## non-list when appropriate.
## 
##
